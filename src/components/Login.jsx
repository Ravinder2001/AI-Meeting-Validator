...
const Login = ({ login }) => {
  return (
    <div className="login-container" style={{
      ...
      >
        <h1 style={{ marginBottom: '20px', background: 'var(--primary-gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
          Meeting Auditor AI
        </h1>
        <p style={{ marginBottom: '40px', color: 'var(--text-secondary)' }}>
          Sign in with your Google Account to access your calendar and automate meeting analysis.
        </p>
